...
// SPIバスの設定
      ...
      cfg.pin_sclk = SPI3_CLK;            // SPIのSCLKピン番号を設定
      cfg.pin_mosi = SPI3_MOSI;            // SPIのMOSIピン番号を設定
      cfg.pin_miso = SPI3_MISO;            // SPIのMISOピン番号を設定 (-1 = disable)
...
//*
    { // タッチスクリーン制御の設定を行います。（必要なければ削除）
      ...
      cfg.pin_int    = -1;   // default: 38 //INTが接続されているピン番号
...
// SPI接続の場合
      ...
      cfg.pin_sclk = SPI3_CLK;     // SCLKが接続されているピン番号
      cfg.pin_mosi = SPI3_MOSI;     // MOSIが接続されているピン番号
      cfg.pin_miso = SPI3_MISO;     // MISOが接続されているピン番号
      cfg.pin_cs   =  TCH_CS;     //   CSが接続されているピン番号
